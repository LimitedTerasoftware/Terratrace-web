...
import FirmManagement from './components/FirmManagement/index';
...
function App() {
  ...
  return loading ? (
    ...
    />*/}
              ...
              />
              <Route
                path="/construction-progress-map"
                element={
                  <>
              ...
              />
              <Route
                path="/installation-gp-checklist/view/:id"
                element={
                  <>
                    <DefaultLayout>
              ...
              />
              <Route
                path="/at-checklist-data-list"
                element={
                  <>
                    <DefaultLayout>
                      <PageTitle title="AT Checklist Data" />
                      <ATChecklistList />
                    </DefaultLayout>
                  </>
                }
              />
              <Route
                path="/at-checklist-data/view/:blockId"
                element={
                  <>
                    <DefaultLayout>
