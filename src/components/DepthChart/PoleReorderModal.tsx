...
import { reorderPoleSurvey } from '../Services/api';
import { PoleString } from '../../types/aerial-survey';

interface PoleReorderModalProps {
  isOpen: boolean;
  onClose: () => void;
  surveyId: number;
  eventData: PoleString[];
  onSuccess: () => void;
}
...
const PoleReorderModal: React.FC<PoleReorderModalProps> = ({
  isOpen,
  onClose,
  surveyId,
  eventData,
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] flex flex-col">
        ...
        <div className="p-4 overflow-y-auto flex-1">
          ...
          <div className="grid grid-cols-12 gap-4 font-semibold text-sm bg-gray-100 p-2 rounded mb-2">
            ...
            <div className="col-span-2">Pit ID</div>
...
export default PoleReorderModal;
