...
import { X, MapPin, Calendar, Camera, Info, Ruler } from 'lucide-react';
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-900 font-semibold">{activity.link_name}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-900">{activity.machine_id}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <h3 className="text-sm font-medium text-gray-600 mb-2">Survey ID</h3>
              <p className="text-gray-900">{activity.survey_id}</p>
            </div>
          </div>
