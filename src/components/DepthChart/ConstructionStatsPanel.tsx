  ...
  const getAcceptedLinksStatsConfig = (data: AcceptedLinksSummary) => [
    {
      ...
      {
      icon: Ruler,
      label: 'BOQ Distance (km)',
      value: (data.actualDistanceMeters/1000)?.toFixed(2) ?? '0.00',
    ...
    {
      icon: MapPin,
      label: 'T&D Distance (km)',
      value: (data.totalDistanceMeters/1000)?.toFixed(2) ?? '0.00',
    ...
    {
      icon: Cable,
      label: 'OFC Distance (km)',
      value: (data.ofcDistanceMeters/1000)?.toFixed(2) ?? '0.00',
